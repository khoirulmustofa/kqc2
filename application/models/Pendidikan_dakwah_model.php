...
class Pendidikan_dakwah_model extends CI_Model
{
    ...
    // get data by judul_seo_pendidikan_dakwah
    function get_by_judul_seo_pendidikan_dakwah($judul_seo_pendidikan_dakwah)
    {
    	$this->db->where('judul_seo_pendidikan_dakwah', $judul_seo_pendidikan_dakwah);
	...
	$this->db->or_like('judul_seo_pendidikan_dakwah', $q);
