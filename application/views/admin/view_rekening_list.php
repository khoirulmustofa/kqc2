	...
	<section class="content">
		...
		<div class="box box-success">
			<div class="box-header with-border">
				<div class="row">
					<div class="col-sm-5">
						<?php echo anchor(site_url('admin/rekening_create'),'Create', 'class="btn btn-success"'); ?>
					</div>
					<div class="col-sm-7 ">
						<form action="<?php echo site_url('admin/rekening'); ?>"
                            ...
                            <?php
																												if ($q != '') {
																													?>
                                    <a
									href="<?php echo site_url('admin/rekening'); ?>"
			...
			<div class="box-body table-responsive no-padding">
				...
				<?php
								echo anchor ( site_url ( 'admin/rekening_update/' . $rekening->id_rekening ), 'Update' );
								echo ' | ';
								echo anchor ( site_url ( 'admin/rekening_delete/' . $rekening->id_rekening ), 'Delete', 'onclick="javasciprt: return confirm(\'Are You Sure ?\')"' );
								?>
			</td>
						</tr>
                <?php
